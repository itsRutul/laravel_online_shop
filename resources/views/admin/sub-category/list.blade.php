                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#" class="text-danger w-4 h-4 mr-1" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $subCategory->id }}').submit();">
                            ...
                            2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                                ...
                                <form id="delete-form-{{ $subCategory->id }}" action="{{ route('sub-categories.destroy', $subCategory->id) }}" method="POST" style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </td>
